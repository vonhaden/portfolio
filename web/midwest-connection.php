...
<div class="project">
    ...
    <section class="project-body uk-section">
        <div class="uk-container" uk-scrollspy="target: > div; cls: uk-animation-slide-left; offset-top: -150">
            ...
            <img class="full-width-image uk-margin-large-bottom" data-src="../img/projects/midwest-connection/highlight-1.jpg" alt="Screenshot of Midwest Connection's homepage." uk-img>
