<?php
// Project Title
$projectTitle = 'Direct Supply Events';
// Page Title
...
$filePath = '../img/projects/direct-supply-events/';
$galleryPath = 'gallery/';
$thumbnailPath = 'thumb/';
$projectGallery = [
    array(
    ...
    array(
        ...
        'caption' => 'DSSI Forum 2018',
        'alt' => 'DSSI Forum 2018 slide.',
        'thumbnail' => $filePath . $thumbnailPath . 'dssi-forum-2018-1.jpg'
    ),
    array(
        'href' => $filePath . $galleryPath . 'dssi-forum-2018-2.jpg',
        'caption' => 'DSSI Forum 2018',
        'alt' => 'DSSI Forum 2018 slide.',
        'thumbnail' => $filePath . $thumbnailPath . 'dssi-forum-2018-2.jpg'
    ),
    array(
        'href' => $filePath . $galleryPath . 'dssi-forum-2018-3.jpg',
        'caption' => 'DSSI Forum 2018',
        'alt' => 'DSSI Forum 2018 slide.',
        'thumbnail' => $filePath . $thumbnailPath . 'dssi-forum-2018-3.jpg'
    ),
    array(
